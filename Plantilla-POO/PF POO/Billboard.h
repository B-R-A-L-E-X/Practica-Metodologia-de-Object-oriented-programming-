...
public:
	...
	Billboard(HWND hWnd, WCHAR textura[], float ancho, float alto, float x, float y, float z, bool _animacion)
	{
		this->ancho = ancho;
		this->alto = alto;	
		this->x = x;
	...
	bool getAnim() { return animacion; }
	void setAnim(bool _animacion) { animacion = _animacion; }
