...
LRESULT CALLBACK WindowProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_KEYDOWN:
		...
		case VK_RIGHT:
			...
			return 0;
		case 0x44: //D
			scene->pxAnt = scene->px;
			scene->pzAnt = scene->pz;
			scene->move('r');
			renderiza = true;
			return 0;
		case 0x41: //A
